...
unsigned int isObstacle(unsigned char *in, size_t in_size)
{	
	int cnt = 0;
	for(int i=0; i<200; i+=2)
	{		
		if(in[(480-20-i/2)*WIDTH+(320-(200-i))]!=1 && in[(480-20-i/2)*WIDTH+(320-(200-i))]!=0 && in[(480-20-i/2)*WIDTH+(320-(200-i))]!=4)
		{
			cnt = 0;
			if(in[(480-20-i/2+2)*WIDTH+(320-(200-i+2))]!=1 && in[(480-20-i/2+2)*WIDTH+(320-(200-i+2))]!=0 && in[(480-20-i/2+2)*WIDTH+(320-(200-i+2))]!=4)
				cnt++;
			if(in[(480-20-i/2-2)*WIDTH+(320-(200-i+2))]!=1 && in[(480-20-i/2-2)*WIDTH+(320-(200-i+2))]!=0 && in[(480-20-i/2-2)*WIDTH+(320-(200-i+2))]!=4)
				cnt++;
			if(in[(480-20-i/2+2)*WIDTH+(320-(200-i-2))]!=1 && in[(480-20-i/2+2)*WIDTH+(320-(200-i-2))]!=0 && in[(480-20-i/2+2)*WIDTH+(320-(200-i-2))]!=4)
		...
		if(in[(480-20-i/2)*WIDTH+(320+(200-i))] !=1 && in[(480-20-i/2)*WIDTH+(320+(200-i))]!=0 && in[(480-20-i/2+2)*WIDTH+(320+(200-i))]!=4)
		{
			cnt = 0;
			if(in[(480-20-i/2+2)*WIDTH+(320+(200-i+2))]!=1 && in[(480-20-i/2+2)*WIDTH+(320+(200-i+2))]!=0 && in[(480-20-i/2+2)*WIDTH+(320+(200-i+2))]!=4)
				cnt++;
